...
/**
 * PALAVRA CHAVE FINAL EM CLASSES:
 * --> Não é possível estender uma classe com a palavra chave final
 * public final class Pessoa{}
 * Não permite herança
 */

/**
 * PALAVRA CHAVE FINAL EM ATRIBUTOS/VARIÁVEIS:
 * --> Torna a variável imutável, constante, não pode ser mudado
 */
public class Pessoa {
